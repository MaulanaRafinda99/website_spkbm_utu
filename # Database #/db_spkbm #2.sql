...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 09, 2024 at 04:10 PM
...
(69, '2005903040019', 'Kartika', 10.6667, 7.33333, 9.66667);

-- --------------------------------------------------------

--
-- Table structure for table `nilai_skill`
--
...
--
-- Dumping data for table `nilai_skill`
--
...
(67, '2105903040015', 'Nofrian Safutra ', 'Analisa Sistem', '', 6.25, 0, 0),
...
(83, '2105903040023', 'Muhammad danil', 'Analisa Sistem, Pengembangan Perangkat Lunak, Pengelolaan Basis Data, Pemrograman (Webphyton,Android), Analisis dan Desain Perangkat Lunak, Pengembangan Perangkat Lunak Berbasis Proyek, Pengembangan Perangkat Lunak', '', 18.75, 0, 25),
...
(102, '2005903040019', 'Kartika', 'Analisa Sistem, Manajemen Proyek Teknologi Informasi, Analisis dan Desain Perangkat Lunak', '', 12.5, 0, 6.25);

-- --------------------------------------------------------

--
-- Table structure for table `tingkat_minat`
--
...
--
-- Dumping data for table `tingkat_minat`
--
...
(69, '2005903040019', 'Kartika', 4, 3, 3);
...
(62, 'Test Registrasi', 'test123@gmail', '$2y$10$zsn9mV0VVoprBhzsspSw6.lTkmfXEZ9wOtAAlJTDpoVChSGZvS4XW'),
(64, 'Kartika', '2005903040019', '$2y$10$0Zr7ZRYOAbPNnMyxu.cebOdD6P/LUT/WsOVYw9nytggHPJmsWN0Qe');
...
--
-- Indexes for table `tingkat_minat`
--
...
--
-- AUTO_INCREMENT for table `nilai_skill`
--
ALTER TABLE `nilai_skill`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=106;

--
-- AUTO_INCREMENT for table `tingkat_minat`
--
ALTER TABLE `tingkat_minat`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
