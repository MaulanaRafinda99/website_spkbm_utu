...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 10 Des 2024 pada 23.29
...
(28, '2005903040013', 'Dewi Candra', 9.5, 9.83333, 11.5),
...
CREATE TABLE `nilai_skill` (
  ...
  `nilaiSkill` varchar(25) DEFAULT NULL,
  `nilaiSI` float NOT NULL,
  `nilaiJ` float NOT NULL,
  `nilaiRPL` float NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(61, '2005903040013', 'Dewi Candra', 'Analisa Sistem, Pengembangan Perangkat Lunak, Local Area Network, Pengembangan Perangkat Lunak Berbasis Proyek', '', 2, 1, 1),
