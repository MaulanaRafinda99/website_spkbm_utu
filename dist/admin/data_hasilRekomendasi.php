...
if (isset($_GET['nim'])) {
    $nim = $_GET['nim'];
    $sql = "SELECT * FROM hasil_rekomendasi";
    $stmt = $conn->prepare($sql);
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h3 class="mt-4 ml-1">Data Mahasiswa</h3>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Daftar Data Hasil Rekomendasi</li>
                    </ol>
                </div>
            </main>

            <!-- Tabel Data Mahasiswa -->
            <div class="container table-responsive center" style="margin-left: 5%;">
                <div class="row">
                    <div class="col-10">
                        ...
                        <a href='konfirmasi_hapusRekomendasi.php?nim=" . $row['nim'] . "' class='btn btn-danger'><i class='far fa-trash-alt'></i></a>
                      </td>";
